...
if (isset($_GET['releated_columns'])) {
    ...
    $columns = maia_tbay_get_config('releated_product_columns', 4);
}
...
$show_product_releated = maia_tbay_get_config('enable_product_releated', true);

$heading = apply_filters('woocommerce_product_related_products_heading', esc_html__('Related products', 'maia'));
