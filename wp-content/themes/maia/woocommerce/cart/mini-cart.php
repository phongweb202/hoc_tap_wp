		...
		<div class="mcart-border">
							...
							<li class="mini-cart-item <?php echo esc_attr( apply_filters( 'woocommerce_mini_cart_item_class', 'mini_cart_item', $cart_item, $cart_item_key ) ); ?>">
								...
								<div class="product-details">
									...
									<div class="group">
										...
										<?php 
											if ( maia_tbay_get_config('show_mini_cart_qty', false) ) :
			...
			<?php else: ?>
				<ul class="cart_empty <?php echo esc_attr($args['list_class']); ?>">
					<li><span><?php esc_html_e('Your cart is empty', 'maia') ?></span></li>
					<li class="total"><a class="button wc-continue" href="<?php echo esc_url(apply_filters('woocommerce_return_to_shop_redirect', wc_get_page_permalink('shop'))); ?>"><?php esc_html_e('Continue Shopping', 'maia') ?><i class="tb-icon tb-icon-angle-right"></i></a></li>
				</ul>
			<?php endif; ?>
			...
			<?php if (sizeof(WC()->cart->get_cart()) > 0) : ?>
				<div class="group-button">
					...
					<p class="buttons">
						<a href="<?php echo esc_url(wc_get_cart_url()); ?>" class="button view-cart"><?php esc_html_e('View Cart', 'maia'); ?></a>
						<a href="<?php echo esc_url(wc_get_checkout_url());?>" class="button checkout"><?php esc_html_e('Checkout', 'maia'); ?></a>
					</p>
				</div>
			<?php endif; ?>
