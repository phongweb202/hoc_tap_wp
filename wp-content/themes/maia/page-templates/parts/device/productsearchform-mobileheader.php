	...
	<?php
        ...
        $autocomplete_search 		=  maia_tbay_get_config('mobile_autocomplete_search', true);
        $enable_search_category 	=  maia_tbay_get_config('mobile_enable_search_category', false);
        $enable_subtitle 				=  maia_tbay_get_config('mobile_show_search_product_subtitle', false);
        $enable_image 				=  maia_tbay_get_config('mobile_show_search_product_image', true);
        $enable_price 				=  maia_tbay_get_config('mobile_show_search_product_price', true);
        $search_type 				=  maia_tbay_get_config('mobile_search_type', 'post');
        $number 					=  maia_tbay_get_config('mobile_search_max_number_results', 5);
        $minchars 					=  maia_tbay_get_config('mobile_search_min_chars', 3);

        $text_categories_search 	=  esc_html__('All', 'maia');
        $search_placeholder 		=  '';

        if ($search_type ==='product') {
            $search_placeholder 		=  maia_tbay_get_config('mobile_search_placeholder', esc_html__('Search for products...', 'maia'));
        } else {
            $search_placeholder 		=  maia_tbay_get_config('mobile_search_placeholder', esc_html__('Search for posts...', 'maia'));
        }
