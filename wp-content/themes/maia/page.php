...
get_header();
$sidebar_configs = maia_tbay_get_page_layout_configs();
...
<section id="main-container" class="<?php echo esc_attr(apply_filters('maia_tbay_page_content_class', 'container'));?>">
		...
		<div id="main-content" class="main-page <?php echo esc_attr($sidebar_configs['main']['class']); ?>">
			<div id="main" class="site-main">
                ...
                while (have_posts()) : the_post();
                    ...
                    wp_link_pages(
                        array(
                            'before' => '<div class="page-links">' . esc_html__('Pages:', 'maia'),
                            'after'  => '</div>',
                        )
                    );
