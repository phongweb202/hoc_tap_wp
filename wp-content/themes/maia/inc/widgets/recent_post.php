...
class Tbay_Widget_Recent_Post extends Tbay_Widget
{
    public function __construct()
    {
        parent::__construct(
            'maia_recent_post',
            esc_html__('Maia Recent Posts', 'maia'),
            array( 'description' => esc_html__('Show list of recent post', 'maia'), )
        );
    ...
    public function form($instance)
    {
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('number_post')); ?>"><?php esc_html_e('Num Posts:', 'maia'); ?></label>
