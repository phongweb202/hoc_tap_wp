...
if (!class_exists("Maia_Tbay_Custom_Nav_Menu")) {
    class Maia_Tbay_Custom_Nav_Menu extends Walker_Nav_Menu
    {
        ...
        public function start_el(&$output, $item, $depth = 0, $args = array(), $id = 0)
        {
            ...
            if (isset($item->tbay_text_label) && !empty($item->tbay_text_label)) {
                switch ($item->tbay_text_label) {
                    case 'label_new':
                        $text_label  = esc_html__('New', 'maia');
                        break;

                    case 'label_hot':
                        $text_label  = esc_html__('Hot', 'maia');
                        break;

                    case 'label_featured':
                        $text_label  = esc_html__('Sale', 'maia');
                        break;
