...
if (! function_exists('maia_tbay_recently_viewed_set_cookie_meta')) {
    function maia_tbay_recently_viewed_set_cookie_meta($products_list)
    {
        $user_id            = get_current_user_id();
        $meta_products_list = 'maia_recently_viewed_product_list';
        $cookie_name        = 'maia_recently_viewed_products_list';
...
if (! function_exists('maia_tbay_wc_track_user_get_cookie')) {
    function maia_tbay_wc_track_user_get_cookie()
    {
        $user_id            = get_current_user_id();
        $cookie_name        = 'maia_recently_viewed_products_list';
        $meta_products_list = 'maia_recently_viewed_product_list';
...
if (! function_exists('maia_tbay_wc_track_user_viewed_produts')) {
    function maia_tbay_wc_track_user_viewed_produts()
    {
        global $post;
        ...
        maia_tbay_recently_viewed_set_cookie_meta($products_list);
    }
    add_action('template_redirect', 'maia_tbay_wc_track_user_viewed_produts', 99);
    add_action('init', 'maia_tbay_wc_track_user_viewed_produts', 99);
}

if (! function_exists('maia_tbay_get_products_recently_viewed')) {
    function maia_tbay_get_products_recently_viewed($number_post = 8)
    {
        $products_list      = maia_tbay_wc_track_user_get_cookie();
...
if (! function_exists('maia_tbay_wc_get_recently_viewed')) {
    function maia_tbay_wc_get_recently_viewed()
    {
        $num_post           =   maia_tbay_get_config('max_products_recentview', 8);
            
        $args = maia_tbay_get_products_recently_viewed($num_post);
