...
if (!function_exists('maia_before_render_sticky_header')) {
    function maia_before_render_sticky_header($widget)
    {
    ...
    add_action('elementor/frontend/section/before_render', 'maia_before_render_sticky_header', 10, 2);
}
