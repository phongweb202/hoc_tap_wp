...
if (! defined('ABSPATH') || function_exists('Maia_Elementor_Product_Categories_Tabs')) {
 ...
 * @since 1.0.0
 */
class Maia_Elementor_Product_Categories_Tabs extends Maia_Elementor_Carousel_Base
{
    /**
     * Get widget name.
     *
    ...
    {
        return esc_html__('Maia Product Categories Tabs', 'maia');
    }
    ...
    protected function register_controls()
    {
        ...
        $this->start_controls_section(
            'section_general',
            [
                'label' => esc_html__('Product Categories', 'maia'),
            ]
        );
        ...
        $this->add_control(
            'ajax_tabs',
            [
                'label' => esc_html__( 'Ajax Categories Tabs', 'maia' ),
                'type' => Controls_Manager::SWITCHER,
                'default' => 'yes',
                'description' => esc_html__( 'Show/hidden Ajax Categories Tabs', 'maia' ), 
            ]
        );
        ...
        $this->add_control(
            'icon_after_title',
            [
                'label' => esc_html__( 'Show Icon After Title', 'maia' ),
                'type' => Controls_Manager::SWITCHER,
                'default' => 'yes',
                'description' => esc_html__( 'Show/hidden Icon After Title', 'maia' ), 
        ...
        $this->add_control(
            'categories_tabs',
            [
                'label' => esc_html__('Categories Items', 'maia'),
    ...
    private function register_category_repeater()
    {
        ...
        $repeater->add_control(
            'category',
            [
                'label' => esc_html__('Select Category', 'maia'),
                'type'      => Controls_Manager::SELECT,
        ...
        $repeater->add_control(
            'icon_category',
            [
                'label' => esc_html__('Select Icon', 'maia'),
                'type'      => Controls_Manager::ICONS,
                'default' => [
                    'value' => 'tb-icon tb-icon-brush', 
                    'library' => 'tbay-custom',
                ], 
            ]
        );
    ...
    protected function register_button()
    {
        ...
        $this->add_control(
            ...
            [
                ...
                'default'   => esc_html__('Show all', 'maia'),
    ...
    public function render_product_tab($item, $_id, $_count, $random_id,$icon)
    {
        ...
        $title = $category->name; ?>
        <li >  
            <a href="javascript:void(0)" data-bs-toggle="pill" data-bs-target="#<?php echo esc_attr($item.'-'. $random_id .'-'.$_id); ?>" class="<?php echo esc_attr($active); ?>" data-value="<?php echo esc_attr($item); ?>"> <?php $this->render_item_icon($icon); ?><?php echo trim($title); ?></a>
        </li>
    ...
    private function render_content_tab($key, $tab_active, $_id, $random_id)
    {
        ...
        /** Get Query Products */
        $loop = maia_get_query_products($key, $cat_operator, $product_type, $limit, $orderby, $order);
...
$widgets_manager->register(new Maia_Elementor_Product_Categories_Tabs());
