...
if (! defined('ABSPATH') || function_exists('Maia_Elementor_Product_List_Tags')) {
    exit; // Exit if accessed directly.
}

use Elementor\Controls_Manager;

class Maia_Elementor_Product_List_Tags extends Maia_Elementor_Carousel_Base
{
    ...
    { 
        return esc_html__('Maia Icon List Tags', 'maia');
    }
...
$widgets_manager->register(new Maia_Elementor_Product_List_Tags());
