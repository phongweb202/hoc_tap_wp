...
if (! defined('ABSPATH') || function_exists('Maia_Elementor_Button')) {
 ...
 * @since 1.0.0
 */
class Maia_Elementor_Button extends Maia_Elementor_Widget_Base
{
    /**
     * Get widget name.
     *
    ...
    {
        return esc_html__('Maia Button', 'maia');
    }
    ...
    protected function register_controls()
    {
        ...
        $this->add_control(
            'link_button',
            [
                'label' => esc_html__('Link Button', 'maia'),
        ...
        $this->add_control(
            'add_icon',
            [
                'label' => esc_html__('Add Icon', 'maia'),
...
$widgets_manager->register(new Maia_Elementor_Button());
