...
if (! defined('ABSPATH') || function_exists('Maia_Elementor_Brands')) {
 ...
 * @since 1.0.0
 */
class Maia_Elementor_Brands extends Maia_Elementor_Carousel_Base
{
    /**
     * Get widget name.
     *
    ...
    {
        return esc_html__('Maia Brands', 'maia');
    }
    ...
    protected function register_controls()
    {
        ...
        $this->add_control(
            'brands',
            [
                'label' => esc_html__('Brand Items', 'maia'),
...
$widgets_manager->register(new Maia_Elementor_Brands());
