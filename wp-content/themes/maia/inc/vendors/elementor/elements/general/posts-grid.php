...
if (! defined('ABSPATH') || function_exists('Maia_Elementor_Posts_Grid')) {
...
class Maia_Elementor_Posts_Grid extends Maia_Elementor_Carousel_Base
{
    ...
    {
        return esc_html__('Maia Posts Grid', 'maia');
    }
    ...
    protected function register_controls()
    {
        ...
        $this->add_control(
            'limit',
            [
                'label' => esc_html__('Number of posts', 'maia'),
                'type' => Controls_Manager::NUMBER,
                'description' => esc_html__('Number of posts to show ( -1 = all )', 'maia'),
                'default' => 6,
                'min'  => -1
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => 'post_date',
                'options' => [
                    'post_date'  => esc_html__('Date', 'maia'),
                    'post_title' => esc_html__('Title', 'maia'),
    ...
    protected function register_title_controls()
    {
        ...
        $this->add_control(
            ...
            [
                ...
                'label_on' => esc_html__('Show', 'maia'),
                'label_off' => esc_html__('Hide', 'maia'),
                'default' => 'yes',
    ...
    protected function register_excerpt_controls()
    {
        ...
        $this->add_control(
            'excerpt_length',
            [
                'label' => esc_html__('Excerpt Length', 'maia'),
                'type' => Controls_Manager::NUMBER,
    ...
    protected function register_read_more_controls()
    {
        $this->add_control(
            'advanced_read_more',
            [
                'label' => esc_html__('Read More', 'maia'),
                'type' => Controls_Manager::HEADING,
                'separator' => 'before',
            ]
        );
        ...
        $this->add_control(
            'read_more_text',
            [
                'label' => esc_html__('Read More Text', 'maia'),
    ...
    protected function register_meta_controls()
    {
        ...
        $this->add_control(
            'show_comments',
            [
                'label' => esc_html__('Comments', 'maia'),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => esc_html__('Show', 'maia'),
                'label_off' => esc_html__('Hide', 'maia'),
                'default' => 'no',
        ...
        $this->add_control(
            'show_comments_text',
            [
                'label' => esc_html__('Comments Text', 'maia'),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => esc_html__('Show', 'maia'),
                'label_off' => esc_html__('Hide', 'maia'),
                'default' => 'no',
    ...
    {
        $folderes = glob(MAIA_PAGE_TEMPLATES. '/posts/item-*');
...
$widgets_manager->register(new Maia_Elementor_Posts_Grid());
