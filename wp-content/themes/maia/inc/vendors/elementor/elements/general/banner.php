...
if (! defined('ABSPATH') || function_exists('Maia_Elementor_Banner')) {
 ...
 * @since 1.0.0
 */
class Maia_Elementor_Banner extends Maia_Elementor_Widget_Base
{
    /**
     * Get widget name.
     *
    ...
    {
        return esc_html__('Maia Banner', 'maia');
    }
    ...
    protected function register_controls()
    {
        ...
        $this->add_control(
            'link',
            [
                'label'       => esc_html__('Link', 'maia'),
                'description' => esc_html__('Enter URL if you want this banner to have a link.', 'maia'),
    ...
    protected function register_controls_general_style()
    {
        ...
        $this->start_controls_tab(
            'general_tab_normal',
            [
                'general' => esc_html__('Normal', 'maia'),
            ]
        );
        ...
        $this->add_control(
            'general_bg_color',
            [
                'general' => esc_html__('Background', 'maia'),
        ...
        $this->add_control(
            'heading_layout',
            [
                'label' => esc_html__('Layout Content', 'maia'),
                'type' => Controls_Manager::HEADING,
                'separator'   => 'before',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label'   => esc_html__('Horizontal alignment', 'maia'),
        ...
        $this->add_control(
            ...
            [
                'label'   => esc_html__('Vertical alignment', 'maia'),
                'type' => Controls_Manager::CHOOSE,
                'options' => [
                    'flex-start' => [
                        'title' => esc_html__('Top', 'maia'),
                        'icon' => 'fa fa-arrow-up',
                    ],
                    'center' => [
                        'title' => esc_html__('Middle', 'maia'),
                        'icon' => 'fa fa-align-center',
                    ],
                    'flex-end' => [
                        'title' => esc_html__('Bottom', 'maia'),
        ...
        $this->add_control(
            ...
            [
                'label'   => esc_html__('Text alignment', 'maia'),
                'type' => Controls_Manager::CHOOSE,
                'options' => [
                    'left' => [
                        'title' => esc_html__('left', 'maia'),
        ...
        $this->add_responsive_control(
            'general_width',
            [
                'label'          => esc_html__('Max Width', 'maia'),
    ...
    protected function register_controls_content_section()
    {
        ...
        $this->add_control(
            ...
            [
                ...
                'default'     => esc_html__('This is the heading', 'maia'),
                'placeholder' => esc_html__('Enter your title', 'maia'),
                'label_block' => true,
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label'       => esc_html__('Sub Title', 'maia'),
                'type'        => Controls_Manager::TEXT,
                'placeholder' => esc_html__('Enter your sub-title', 'maia'),
                'label_block' => true,
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'default'     => esc_html__('Click edit button to change this text. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.', 'maia'),
                'placeholder' => esc_html__('Enter your description', 'maia'),
                'separator'   => 'none',
                'rows'        => 10,
            ]
        );
...
$widgets_manager->register(new Maia_Elementor_Banner());
