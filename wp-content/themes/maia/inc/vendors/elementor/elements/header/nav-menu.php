...
if (! defined('ABSPATH') || function_exists('Maia_Elementor_Nav_Menu')) {
...
class Maia_Elementor_Nav_Menu extends Maia_Elementor_Widget_Base
{
    ...
    {
        return esc_html__('Maia Nav Menu', 'maia');
    }
    ...
    protected function register_controls()
    {
        ...
        if (!empty($menus)) {
            $this->add_control(
                ...
                [
                    ...
                    'save_default' => true,
                    'separator'    => 'after',
                    'description'  => sprintf(__('Go to the <a href="%s" target="_blank">Menus screen</a> to manage your menus.', 'maia'), admin_url('nav-menus.php')),
                ]
            );
        } else {
            $this->add_control(
        ...
        $this->add_control(
            'layout',
            [
                'label'              => esc_html__('Layout Menu', 'maia'),
                'type'               => Controls_Manager::SELECT,
                'default'            => 'horizontal',
                'options'            => [
                    'horizontal' => esc_html__('Horizontal', 'maia'),
                    'vertical'   => esc_html__('Vertical', 'maia'),
                    'treeview'   => esc_html__('Tree View', 'maia'),
                ],
        ...
        $this->add_control(
            'hidden_indicator',
            [
                'label'        => esc_html__('Hidden Submenu Indicator', 'maia'),
        ...
        $this->add_control(
            'type_menu',
            [
                'label'              => esc_html__('Type Menu', 'maia'),
                'type'               => Controls_Manager::SELECT,
                'default'            => 'none',
                'options'            => [
                    'none'      => esc_html__('None', 'maia'),
                    'toggle'    => esc_html__('Toggle Menu', 'maia'),
                    'canvas'    => esc_html__('Canvas Menu', 'maia'),
                ],
                'condition' => [
                    'layout!' => 'horizontal',
                ],
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Show Canvas Menu Class', 'maia'),
    ...
    private function register_section_style_main_menu()
    {
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__('Main Menu', 'maia'),
        ...
        $this->add_control(
            'bg_menu',
            [
                'label'     => esc_html__('Background Color Full', 'maia'),
        ...
        $this->add_control(
            ...
            [
                'label'        => esc_html__('No Margin-Left First Item', 'maia'),
                'type'         => Controls_Manager::SWITCHER,
    ...
    private function register_section_style_menu_canvas()
    {
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Icon content', 'maia'),
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Title next to the icon', 'maia'),
                'type' => Controls_Manager::HEADING,
                'separator' => 'before',
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                'label' => esc_html__('Alignment Title', 'maia'),
                'type' => Controls_Manager::CHOOSE,
                'options' => [
                    'left' => [
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Positioning Content', 'maia'),
                'type' => Controls_Manager::HEADING,
                'separator' => 'before',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Title Content', 'maia'),
                'type' => Controls_Manager::HEADING,
                'separator' => 'before',
            ]
        );
    ...
    private function register_section_style_menu_dropdown()
    {
        $this->start_controls_section(
            ...
            [
                'label'     => esc_html__('Dropdown', 'maia'),
                'tab'       => Controls_Manager::TAB_STYLE,
            ]
        );
        ...
        $this->add_responsive_control(
            'dropdown_Heading',
            [
                'label'     => esc_html__('Heading sub title megamenu', 'maia'),
                'type'      => Controls_Manager::SLIDER,
                'range'     => [
                    'px' => [
                        'max' => 50,
        ...
        $this->add_responsive_control(
            ...
            [
                'label'     => esc_html__('Horizontal Padding', 'maia'),
                'type'      => Controls_Manager::SLIDER,
                'selectors' => [
        ...
        $this->add_responsive_control(
            ...
            [
                'label'     => esc_html__('Vertical Padding', 'maia'),
                'type'      => Controls_Manager::SLIDER,
                'range'     => [
                    'px' => [
                        'max' => 50,
    ...
    private function register_section_toggle_menu()
    {
        $this->start_controls_section(
            'section_toggle_menu',
            [
                'label' => esc_html__('Toggle Menu', 'maia'),
                'condition' => [
                    'type_menu' => 'toggle',
                    'layout!' => 'horizontal',
                ],
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'options' => [
                    ...
                    'justify' => [
                        'title' => esc_html__('Justified', 'maia'),
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Title HTML Tag', 'maia'),
                'type' => Controls_Manager::SELECT,
                'options' => [
                    'h1' => 'H1',
                    'h2' => 'H2',
        ...
        $this->add_control(
            'toggle_content_menu',
            [
                'label' => esc_html__('Toggle content menu', 'maia'),
                'type' => Controls_Manager::SWITCHER,
        ...
        $this->add_control(
            'ajax_toggle',
            [
                'label' => esc_html__( 'Ajax Toggle Menu', 'maia' ),
                'type' => Controls_Manager::SWITCHER,
                'default' => 'yes',
                'description' => esc_html__( 'Show/hidden Ajax Toggle Menu', 'maia' ), 
                'condition' => [
        ...
        $this->add_control(
            'show_content_menu',
            [
                'label' => esc_html__('Show content menu', 'maia'),
                'description' => esc_html__('Show content menu on home page', 'maia'),
                'type' => Controls_Manager::SWITCHER,
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Show Icon', 'maia'),
                'type' => Controls_Manager::SWITCHER,
            ]
        );
    ...
    private function register_section_vertical_menu()
    {
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__('Vertical Menu', 'maia'),
                'condition' => [
                    'layout' => 'vertical',
                ],
            ]
        ...
        $this->add_responsive_control(
            ...
            [
                'label' => esc_html__('Alignment Sub Menu', 'maia'),
                'type' => Controls_Manager::CHOOSE,
                'options' => [
                    'left' => [
                        'title' => esc_html__('Left', 'maia'),
    ...
    private function register_section_canvas_menu()
    {
        $this->start_controls_section(
            'section_canvas_menu',
            [
                'label' => esc_html__('Canvas Menu', 'maia'),
                'condition' => [
                    'type_menu' => 'canvas',
                    'layout!' => 'horizontal',
                ],
        ...
        $this->add_control(
            'ajax_canvas',
            [
                'label' => esc_html__( 'Ajax canvas Menu', 'maia' ),
                'type' => Controls_Manager::SWITCHER,
                'description' => esc_html__( 'Show/hidden Ajax canvas Menu', 'maia' ), 
                'default' => 'yes',
                'condition' => [ 
                    'type_menu' => 'canvas',
                    'layout!' => 'horizontal',
    ...
    private function register_section_style_toggle_menu()
    {
        ...
        $this->add_control(
            ...
            [
                'label'     => esc_html__('Hover Text Color', 'maia'),
                'type'      => Controls_Manager::COLOR,
                'default'   => '',
                'selectors' => [
...
$widgets_manager->register(new Maia_Elementor_Nav_Menu());
