...
if (! defined('ABSPATH') || function_exists('Maia_Elementor_Widget_Image')) {
    exit; // Exit if accessed directly.
}

use Elementor\Controls_Manager;

class Maia_Element_Site_Logo extends Maia_Elementor_Widget_Image
{
    public function get_name()
    {
        // `theme` prefix is to avoid conflicts with a dynamic-tag with same name.
        return 'maia-site-logo';
    }

    public function get_title()
    {
        return esc_html__('Maia Site Logo', 'maia');
    }
        ...
        $this->update_control(
            ...
            [
                ...
                'options' => [
                    ...
                    'home' => esc_html__('Home Page', 'maia'),
                    'custom' => esc_html__('Custom URL', 'maia'),
                ],
            ]
        );
    ...
    {
        $logo_image = MAIA_IMAGES . '/logo-default.svg';
...
$widgets_manager->register(new Maia_Element_Site_Logo());
