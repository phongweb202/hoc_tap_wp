...
if (! defined('ABSPATH') || function_exists('Maia_Elementor_Compare')) {
...
class Maia_Elementor_Compare extends Maia_Elementor_Widget_Base
{
    ...
    {
        return esc_html__('Maia Compare', 'maia');
    }
    ...
    protected function register_controls()
    {
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => esc_html__('My Compare', 'maia'),
                'condition' => [
...
$widgets_manager->register(new Maia_Elementor_Compare());
