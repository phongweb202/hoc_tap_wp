...
if (! defined('ABSPATH') || function_exists('Maia_Elementor_Account')) {
...
class Maia_Elementor_Account extends Maia_Elementor_Widget_Base
{
    ...
    {
        return esc_html__('Maia Account', 'maia');
    }
    ...
    protected function register_controls()
    {
        ...
        $this->add_control(
            'show_text_account',
            [
                'label'              => esc_html__('Display Text Account', 'maia'),
        ...
        $this->add_control(
            'text_before',
            [
                'label'              => esc_html__('Text Before Login', 'maia'),
        ...
        $this->add_control(
            'text_after',
            [
                'label'              => esc_html__('Text After Login', 'maia'),
                'type'               => Controls_Manager::TEXT,
                'condition'          => [
                    'show_text_account' => 'yes'
                ]        
        ...
        $this->add_control(
            'show_sub_account',
            [
                'label'              => esc_html__('Display Sub Menu', 'maia'),
                'type'               => Controls_Manager::SWITCHER,
                'default' => 'yes',
            ]
        );
        ...
        if (!empty($menus)) {
            $this->add_control(
                'sub_menu_account',
                [
                    'label'        => esc_html__('Choose Menu', 'maia'),
        ...
        $this->add_control(
            'show_popup_login',
            [
                'label'              => esc_html__('Display Popup Login', 'maia'),
                'type'               => Controls_Manager::SWITCHER,
                'default' => 'yes',
            ]
        );
    ...
    protected function register_section_style_icon()
    {
        ...
        $this->add_control(
            ...
            [
                'label'     => esc_html__('Padding Icon Account', 'maia'),
    ...
    public function check_login($show_text_account,$text_after,$text_before)
    {
        if (is_user_logged_in()) {
            ...
            if(!empty($text_before)) {
                ...
                $name = esc_html__('Login/Register', 'maia');
            }
...
$widgets_manager->register(new Maia_Elementor_Account());
