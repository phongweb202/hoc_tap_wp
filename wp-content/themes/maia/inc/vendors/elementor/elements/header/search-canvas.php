...
if ( ! defined( 'ABSPATH' ) || function_exists('Maia_Elementor_Search_Canvas') ) {
...
class Maia_Elementor_Search_Canvas extends Maia_Elementor_Widget_Base {
    ...
    public function get_title() {
        return esc_html__('Maia Search Canvas', 'maia');
    }
    ...
    protected function _register_form_canvas() {
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => esc_html__('Search for products...','maia'),
            ]
        );
        $this->add_control(
            'vali_input_search',
    ...
    protected function register_style_search_canvas() {
        ...
        $this->add_control(
            'padding_search',
            [
                'label'     => esc_html__('Padding Icon Search', 'maia'),
                'type'       => Controls_Manager::DIMENSIONS,
                'size_units' => [ 'px' ],
                'selectors'  => [
                    '{{WRAPPER}} .btn-search-icon > i,
                                ...
                                <div class="button-group input-group-addon">
                                    ...
                                    <?php if ( $enable_categories_search === 'yes' ): ?>
                                        <div class="select-category input-group-addon">
                                            <span class="category-title"><?php esc_html_e( 'Search in:', 'maia' ) ?></span>
...
$widgets_manager->register(new Maia_Elementor_Search_Canvas());
