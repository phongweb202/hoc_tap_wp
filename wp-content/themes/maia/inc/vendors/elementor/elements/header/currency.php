...
if (! defined('ABSPATH') || function_exists('Maia_Elementor_Currency')) {
...
class Maia_Elementor_Currency extends Maia_Elementor_Widget_Base
{
    ...
    {
        return esc_html__('Maia Currency', 'maia');
    }
    ...
    protected function register_controls()
    {
        $this->start_controls_section(
            'section_layout',
            [
                'label' => esc_html__('Currency Settings', 'maia'),
            ]
        );
        ...
        $this->add_control(
            'txt_type',
            [
                'label'              => esc_html__('Choose Type Text', 'maia'),
                'type'               => Controls_Manager::SELECT,
                'options' => [
                    'desc' => esc_html__('Desc', 'maia'),
                    'code' => esc_html__('Code', 'maia')
                ],
                'default' => 'desc'
            ]
        );
        $this->add_control(
            'show_flags',
            [
                'label'              => esc_html__('Show Flags', 'maia'),
        ...
        $this->add_control(
            'position_flags',
            [
                'label'              => esc_html__('Position Flags', 'maia'),
                'type'               => Controls_Manager::SELECT,
                'options' => [
    ...
    protected function maia_currency()
    {
        ...
        if (maia_woocommerce_activated() && class_exists('WOOCS')) {
...
$widgets_manager->register(new Maia_Elementor_Currency());
