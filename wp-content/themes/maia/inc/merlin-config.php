...
require_once(get_parent_theme_file_path(MAIA_INC . '/merlin-data/elementor.php'));

class Maia_Merlin_Config
{
    private $config = [];
    ...
    private function init()
    {
        $wizard = new Merlin(
            ...
            $strings = array(
                ...
                'title%s%s%s%s'       => esc_html__('%1$s%2$s Themes &lsaquo; Theme Setup: %3$s%4$s', 'maia'),
                ...
                'ready-link-1'      => sprintf('<a href="%1$s" target="_blank">%2$s</a>', 'https://tickets.thembay.com/', esc_html__('Ticket System', 'maia')),
                'ready-link-2'      => sprintf('<a href="%1$s">%2$s</a>', 'https://docs.thembay.com/maia/', esc_html__('Documentation', 'maia')),
                'ready-link-3'      => sprintf('<a href="%1$s">%2$s</a>', 'https://www.youtube.com/c/thembay/', esc_html__('Video Tutorials', 'maia')),
                'ready-link-4'      => sprintf('<a href="%1$s">%2$s</a>', 'https://forums.thembay.com/', esc_html__('Forums', 'maia')),
            )
        );
    }
