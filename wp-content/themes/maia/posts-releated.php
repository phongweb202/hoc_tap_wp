<?php
    ...
    $relate_count = maia_tbay_get_config('number_blog_releated', 3);
    $relate_columns = maia_tbay_get_config('releated_blog_columns', 2);
...
?>
    <div class="tbay-addon tbay-addon-blog relate-blog">
        <h4 class="tbay-addon-title">
            <span><?php esc_html_e('Related posts', 'maia'); ?></span>
        </h4>
