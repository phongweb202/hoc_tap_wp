...
jQuery(window).on('elementor/frontend/init', function () {
  if (elementorFrontend.isEditMode() && typeof maia_settings !== "undefined" && Array.isArray(maia_settings.elements_ready.countdowntimer)) {
    $.each(maia_settings.elements_ready.countdowntimer, function (index, value) {
