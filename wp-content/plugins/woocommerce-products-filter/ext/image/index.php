                        ...
                        <table>
                            <tr>
                                ...
                                <td style="padding-top: 0;">
                                    <input type="text" name="woof_settings[<?php echo $term_key ?>][image_url]" value="<?php echo $image ?>" placeholder="<?php esc_html_e('set link to the image', 'woocommerce-products-filter') ?>" class="text" style="width: 600px;" />
