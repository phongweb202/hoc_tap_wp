                    ...
                    <li>
                        <table>
                            <tr>
                                ...
                                <td>
                                    <input type="text" name="woof_settings[color_img][<?php echo $key ?>][<?php echo $t['slug'] ?>]" value="<?php echo $color_img ?>" placeholder="<?php esc_html_e('background image url 25x25', 'woocommerce-products-filter') ?>" class="text" style="width: 600px;" />
